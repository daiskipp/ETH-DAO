...
const Home: NextPage = () => {
  ...
  const editionDrop = useContract(
    '0x59dDfC0f854bab66aAE84E65F56B2AcF30514f07',
    'edition-drop',
  ).contract;

  // トークンコントラクトの初期化
  const token = useContract(
    '0x64Bb60261468DC3A45DFA1F76Cf28557B7d29B3E',
    'token',
  ).contract;
...
useEffect(() => {
  ...
  else if (address && network && network.data && network.data?.chain?.id !== 11155111) {
    console.log('wallet address: ', address);
